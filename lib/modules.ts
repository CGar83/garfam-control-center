...
export const moduleConfigs = {
  ...
  calendarConnections: {
    ...
    title: "Calendar Sync",
    description: "Provider connections, embedded calendar views, and import/export settings for Google Calendar, Apple Calendar, Outlook, and ICS/webcal workflows.",
    ...
    viewModes: ["list"],
    defaultView: "list",
    columns: ["provider", "calendar_name", "sync_direction", "sync_status", "embed_enabled", "last_synced_at"],
    ...
    fields: [
      ...
      { name: "external_calendar_id", label: "External calendar ID", type: "text" },
      {
        ...
        type: "url",
        helper: "Paste only the src URL from Google's iframe embed code.",
        fullWidth: true
      },
      { name: "embed_enabled", label: "Show embedded calendar", type: "checkbox" },
      { name: "embed_height", label: "Embed height", type: "number", helper: "Use 420-1200 pixels. 640 is the default." },
