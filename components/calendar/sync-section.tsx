...
/** Collapsible home for calendar embeds, ICS import/export, and provider connections. Hidden for kids. */
      ...
      <Card className="overflow-hidden">
        ...
        >
          ...
          <span className="min-w-0 flex-1">
            <span className="block text-base font-semibold">Embed, sync &amp; import</span>
            <span className="block text-sm text-muted-foreground">
              Show a Google Calendar iframe, export an ICS, or import one to bring your existing schedule here.
